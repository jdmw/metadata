...
public class MysqlGenerator {
	...
	private static final String PACKAGE_NAME = MysqlGenerator.class.getPackage().getName();
	private static final String MODULE_NAME = "user";
	private static final String OUT_PATH = new File(new File("src","main"),"java").getAbsolutePath();
